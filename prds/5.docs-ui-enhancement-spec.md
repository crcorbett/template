...
- [ ] Code snippets display like IDE file tabs with full file context
- [ ] Architecture diagrams visualise monorepo structure
- [ ] All CLI examples use proper Turbo commands
- [ ] Custom MDX components for enhanced presentation
