/**
 * PostHog API Trait Annotations for Effect Schema
 *
 ...
 */
const annotationMetaSymbol = Symbol.for("distilled-posthog/annotation-meta");
...
export const httpHeaderSymbol = Symbol.for("distilled-posthog/http-header");
export const HttpHeader = (name: string) =>
  makeAnnotation(httpHeaderSymbol, name);

/** Bind member to the HTTP body */
export const httpPayloadSymbol = Symbol.for("distilled-posthog/http-payload");
export const HttpPayload = () => makeAnnotation(httpPayloadSymbol, true);

/** Bind member to a URI path parameter */
export const httpLabelSymbol = Symbol.for("distilled-posthog/http-label");
...
export const httpQuerySymbol = Symbol.for("distilled-posthog/http-query");
...
export const httpResponseCodeSymbol = Symbol.for(
  "distilled-posthog/http-response-code"
);
...
export const jsonNameSymbol = Symbol.for("distilled-posthog/json-name");
...
export const timestampFormatSymbol = Symbol.for(
  "distilled-posthog/timestamp-format"
);
...
export const httpSymbol = Symbol.for("distilled-posthog/http");
...
// =============================================================================
// PostHog Service Traits
// =============================================================================

/** PostHog API service identification */
export const posthogServiceSymbol = Symbol.for(
  "distilled-posthog/posthog-service"
);
export interface PostHogServiceTrait {
  name: string;
  version?: string;
}
export const PostHogService = (trait: PostHogServiceTrait) =>
  makeAnnotation(posthogServiceSymbol, trait);
...
export const restJsonProtocolSymbol = Symbol.for(
  "distilled-posthog/rest-json-protocol"
);
...
/** Get PostHog service trait from a schema */
export const getPostHogService = (
  ast: AST.AST
): PostHogServiceTrait | undefined =>
  getAnnotationUnwrap<PostHogServiceTrait>(ast, posthogServiceSymbol);
